...
pub fn get_prompt(style: &Style) -> String {
    ...
    let style_definition = match style {
        ...
        As a source for style, use phrases like
        ['Oi, bruv, you fancy a pint?', 'Quit your nattering, love. I'm tryna watch the footie.'].
        ",
        Style::Formal => "
        Adapt the given text into Royal British formal style, keeping the original information intact.
        Use elegant language, like:
        - 'Might I inquire as to your preference for this evening's supper?'
        or
        - 'Would you be so kind as to pass the Grey Poupon, Madam?'
        ",
        Style::Scottish => "
        Convert the text into stereotypical Scottish bar style, maintaining the same content.
        Think of phrases like 'Aye, laddie, pass me tha' whisky!' or 'Ye ken the score with them politicians, always blatherin' on.'
        ",
    };
